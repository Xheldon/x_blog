...
const PRECACHE_LIST = [
  "./",
  "./offline.html",
  "//static.xheldon.cn/js/fastclick.min.js",
  "//static.xheldon.cn/js/animatescroll.min.js",
  "//static.xheldon.cn/js/mermaid.8.3.1.js",
  "//static.xheldon.cn/js/MathJax.js",
  "//static.xheldon.cn/js/jquery.nav.js",
  "//static.xheldon.cn/js/jquery.min.js",
  "//static.xheldon.cn/js/bootstrap.min.js",
  "//static.xheldon.cn/js/anchor.min.js",
  "//static.xheldon.cn/js/xheldon-life-blog.min.js",
  "//static.xheldon.cn/js/simple-jekyll-search.min.js",
  "//static.xheldon.cn/js/snackbar.js",
  "//static.xheldon.cn/js/archive.js",
  "//static.xheldon.cn/js/jquery.tagcloud.js",
  "//static.xheldon.cn/css/bootstrap.min.css",
  "//static.xheldon.cn/css/xheldon-life-blog.min.css",
  "//static.xheldon.cn/css/font-awesome.min.css",
  "//static.xheldon.cn/img/being-bg.png",
  "//static.xheldon.cn/img/food-bg.png",
  "//static.xheldon.cn/img/towel-bg.png",
  "//static.xheldon.cn/img/about-new-bg.png",
  "//static.xheldon.cn/img/donate-bg.png",
  "//static.xheldon.cn/img/index-bg.png",
  "//static.xheldon.cn/fonts/fontawesome-webfont.eot",
  "//static.xheldon.cn/fonts/fontawesome-webfont.ttf",
  "//static.xheldon.cn/fonts/fontawesome-webfont.woff",
  "//static.xheldon.cn/fonts/fontawesome-webfont.woff2",
  "//static.xheldon.cn/fonts/FontAwesome.otf",
  "//static.xheldon.cn/fonts/glyphicons-halflings-regular.eot",
  "//static.xheldon.cn/fonts/glyphicons-halflings-regular.svg",
  "//static.xheldon.cn/fonts/glyphicons-halflings-regular.ttf",
  "//static.xheldon.cn/fonts/glyphicons-halflings-regular.woff",
  "//static.xheldon.cn/fonts/glyphicons-halflings-regular.woff2",
  "//static.xheldon.cn/js/gitalk.min.js",
  "//static.xheldon.cn/css/gitalk.css",
  "./resources/img/icon_wechat.png",
  "./resources/img/avatar-xheldon.png",
...
function revalidateContent(cachedResp, fetchedResp) {
  ...
  return Promise.all([cachedResp, fetchedResp])
    .then(([cached, fetched]) => {
      const cachedVer = cached.headers.get('etag')
      const fetchedVer = fetched.headers.get('etag')
